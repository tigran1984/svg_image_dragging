...
//
// Demonstrate how to use FLTK's nanosvg support (new in 1.4.0) --erco 10/29/2017
//

// The svg logo with 'rotate(-45 320 240) added to rotate it around its center
const char *svg_logo =
    "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
    "<!-- Generator: Adobe Illustrator 13.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 14948)  -->\n"
    "<!DOCTYPE svg PUBLIC \"-//W3C//DTD SVG 1.1//EN\" \"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd\">\n"
    "<svg version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\"\n"
    "    width=\"320px\" height=\"240px\" viewBox=\"0 0 640 480\" enable-background=\"new 0 0 640 480\" xml:space=\"preserve\">\n"
...
double Box::percent = 0;

int main(int argc, char **argv) {
    Fl_SVG_Image *svg = new Fl_SVG_Image(NULL, (char*)strdup(svg_logo)); // XXX: strdup() shouldn't be needed -- see STR #3421
    Fl_SVG_Image *svg2 = new Fl_SVG_Image("image.svg");
    //Fl_Window    *win = new Fl_Window(720, 486, "svg test");
    Fl_Scrollbar *scrollbar =  new Fl_Scrollbar(100,100,10,900,"Scrollbar");

    MyOverlayWindow *win = new MyOverlayWindow (900,900);
    Box       *box1 = new Box( win, 100,100,30,30);
    Box       *box2 = new Box( win, 100,200,30,30);
    box1->image(svg);
    box2->image(svg2);
    //scrollbar->add(box1);
    win->end();
    //win->resizable(scrollbar);
    scrollbar->show();
    //resizable(scroll);
    win->show(argc,argv);
    return(Fl::run());
